        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-3 gap-2 gap-md-5">
                ...
                <div class="card-toolbar flex-row-fluid  gap-5">
                    <a href="{{url('/categorys/create')}}" class="btn btn-primary">Add Category</a>
                </div>
                <!--end::Card toolbar-->
            </div>
            <!--end::Card header-->
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        <tr class="text-hover-primary">
                            ...
                            <td class="text-center">
                                <form action="{{route('categorys.destroy',$customer->id)}}" method="post">
                                    <a class='btn btn-primary btn-sm' href="{{route('categorys.show',$customer->id)}}">View</a>
                                    <a class='btn btn-success btn-sm' href="{{route('categorys.edit',$customer->id)}}">Edit</a>
                                    @method('DELETE')
                                    @csrf
